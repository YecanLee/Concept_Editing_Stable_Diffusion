...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        ...
        'wanna load a previously used editor and continue editing the model.') # Continue the training, should not be used in the first time
    ...
    return args
# Check this link if you want to know more about argparse
...
can be used for python(dict), json and yaml file
"""